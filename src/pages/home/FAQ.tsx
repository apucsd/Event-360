...
export const FAQ = () => {
  ...
  return (
    <div className="relative md:my-20 ">
      <div className="grid grid-cols-12 place-items-end justify-center">
        <div
          data-aos="fade-right"
          data-aos-duration="1000"
          className="col-span-12 lg:col-span-7  py-4"
        >
          <div className=" mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between items-center">
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        ...
                        organization. Start by defining your event goals,
                        creating a detailed plan, and coordinating with vendors.
                        Our expert event planners can guide you through the
                        process.
                      </p>
                    </div>
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                      <p className="text-gray-700 text-sm">
                        ...
                        venue selection, catering, entertainment, decorations,
                        and logistics. Our goal is to make your event
        ...
        <div
          data-aos="fade-left"
          data-aos-duration="1000"
          className="w-full col-span-12 md:col-span-5 lg:col-span-5 "
        >
          {View}
        </div>
      </div>
